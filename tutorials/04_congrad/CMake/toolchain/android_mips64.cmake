...
set(CMAKE_ASM_PREPROCESSOR /usr/${cross_triple}/bin/${cross_triple}-clang CACHE FILEPATH "Preprocessor for Android mips64")
...
# archiver
set(CMAKE_AR /usr/${cross_triple}/bin/${cross_triple}-ar CACHE FILEPATH "Archiver for Android mips64")
# linker
set(CMAKE_LD /usr/${cross_triple}/bin/${cross_triple}-ld CACHE FILEPATH "Linker for Android mips64")
# stripper
set(CMAKE_STRIP /usr/${cross_triple}/bin/${cross_triple}-strip CACHE FILEPATH "Stripper for Android mips64")
...
if (CMAKE_COMPILER_IS_GNUCC)
    set(CMAKE_C_FLAGS_RELEASE "${ANDROID_COMMON_C_FLAGS} -Wa,--noexecstack -finline-limit=300 -funswitch-loops -finline-functions -fno-inline-functions-called-once -fgcse-after-reload -frerun-cse-after-loop -frename-registers" CACHE string "Compiler C flags used by release builds for Android mips64")
