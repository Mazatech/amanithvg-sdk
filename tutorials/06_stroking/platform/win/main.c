...
#define WINDOW_TITLE "AmanithVG Tutorial 06 - Press F1 for help"
...
static void helpDialog(void) {
    ...
    strcat(msg, "F1: Help.\n");
    strcat(msg, "Mouse: Move control points.\n");
    strcat(msg, "J: Change join style.\n");
    strcat(msg, "C: Change start cap style.\n");
    strcat(msg, "V: Change end cap style.\n");
    strcat(msg, "D: Change dash pattern.\n");
    strcat(msg, "A: Toggle dash animation.\n");
