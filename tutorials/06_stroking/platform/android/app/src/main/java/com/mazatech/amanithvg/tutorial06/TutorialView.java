...
public class TutorialView extends GLSurfaceView implements GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    static final int TUTORIAL_CHANGE_JOIN_STYLE_CMD = 0;
    static final int TUTORIAL_CHANGE_START_CAP_STYLE_CMD = 1;
    static final int TUTORIAL_CHANGE_END_CAP_STYLE_CMD = 2;
    static final int TUTORIAL_CHANGE_DASH_PATTERN_CMD = 3;
    static final int TUTORIAL_TOGGLE_DASH_ANIMATION_CMD = 4;
    static final int TUTORIAL_ABOUT_CMD = 5;
