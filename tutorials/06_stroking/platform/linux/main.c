...
static void helpDialog(void) {
    ...
    strcat(infoMessage, "Mouse: Move control points.\n");
    strcat(infoMessage, "J: Change join style.\n");
    strcat(infoMessage, "C: Change start cap style.\n");
    strcat(infoMessage, "V: Change end cap style.\n");
    strcat(infoMessage, "D: Change dash pattern.\n");
    strcat(infoMessage, "A: Toggle dash animation.\n");
