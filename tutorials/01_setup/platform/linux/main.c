...
static void helpDialog(void) {
    ...
    strcat(infoMessage, "Mouse: Move the drawing.\n");
    strcat(infoMessage, "A: Toggle animation.\n");
    strcat(infoMessage, "J: Toggle scissoring.\n");
    strcat(infoMessage, "K: Change scissor rectangles.\n");
    strcat(infoMessage, "I: Change color interpolation for gradients.\n");
    strcat(infoMessage, "M: Toggle alpha mask.\n");
    strcat(infoMessage, "P: Change paint type.\n");
    strcat(infoMessage, "S: Change (gradient) spread mode.\n");
    strcat(infoMessage, "T: Change (pattern) tiling mode.\n");
    strcat(infoMessage, "U: Increment gradient repeats.\n");
    strcat(infoMessage, "Y: Decrement gradient repeats.\n");
