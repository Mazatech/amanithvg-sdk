...
import static com.mazatech.amanithvg.tutorial01.TutorialView.*;
...
public class TutorialActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // build the menu
        menu.add(0, TUTORIAL_TOGGLE_ANIMATION_CMD, 0, "Toggle animation");
        menu.add(0, TUTORIAL_CHANGE_PAINT_CMD, 0, "Change paint type");
        menu.add(0, TUTORIAL_CHANGE_SPREAD_MODE_CMD, 0, "Change gradients spread mode");
        menu.add(0, TUTORIAL_CHANGE_COLOR_INTERPOLATION_CMD, 0, "Change gradients color interpolation");
        menu.add(0, TUTORIAL_INC_CONGRAD_REPEATS_CMD, 0, "Increment conical gradient repeats");
        menu.add(0, TUTORIAL_DEC_CONGRAD_REPEATS_CMD, 0, "Decrement conical gradient repeats");
        menu.add(0, TUTORIAL_CHANGE_TILING_MODE_CMD, 0, "Change pattern tiling mode");
        menu.add(0, TUTORIAL_TOGGLE_SCISSORING_CMD, 0, "Toggle scissoring");
        menu.add(0, TUTORIAL_CHANGE_SCISSOR_RECTANGLES_CMD, 0, "Change scissor rectangles");
        menu.add(0, TUTORIAL_TOGGLE_MASK_CMD, 0, "Toggle alpha mask");
