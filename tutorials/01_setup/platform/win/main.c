...
#define WINDOW_TITLE "AmanithVG Tutorial 01 - Press F1 for help"
...
static void helpDialog(void) {
    ...
    strcat(msg, "F1: Help.\n");
    strcat(msg, "Mouse: Move the drawing.\n");
    strcat(msg, "A: Toggle animation.\n");
    strcat(msg, "J: Toggle scissoring.\n");
    strcat(msg, "K: Change scissor rectangles.\n");
    strcat(msg, "I: Change color interpolation for gradients.\n");
    strcat(msg, "M: Toggle alpha mask.\n");
    strcat(msg, "P: Change paint type.\n");
    strcat(msg, "S: Change (gradient) spread mode.\n");
    strcat(msg, "T: Change (pattern) tiling mode.\n");
    strcat(msg, "U: Increment gradient repeats.\n");
    strcat(msg, "Y: Decrement gradient repeats.\n");
...
static VGboolean processKeysPressure(void) {
    ...
    if ((keysPressed['k']) || (keysPressed['K'])) {
        keysPressed['k'] = VG_FALSE;
        keysPressed['K'] = VG_FALSE;
        toggleScissorRects(openvgSurfaceWidthGet(), openvgSurfaceHeightGet());
    }
    else
    // I
    ...
    if ((keysPressed['y']) || (keysPressed['Y'])) {
        keysPressed['y'] = VG_FALSE;
        keysPressed['Y'] = VG_FALSE;
        removeGradientRepeat();
    }
