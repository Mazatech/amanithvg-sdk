...
public class TutorialView extends GLSurfaceView implements GestureDetector.OnDoubleTapListener, GestureDetector.OnGestureListener {
    ...
    static final int TUTORIAL_CHANGE_MASK_OPERATION_CMD = 0;
    static final int TUTORIAL_CHANGE_FIRST_MASK_CMD = 1;
    static final int TUTORIAL_CHANGE_SECOND_MASK_CMD = 2;
    static final int TUTORIAL_ABOUT_CMD = 3;
    ...
    private void activityTitleUpdate() {
        ...
        ((Activity)activity).runOnUiThread(new Runnable() {
            public void run() {
                ...
                final String title = appName + " (" + maskOperationStr(tutorial.getMaskOperation()) + ")";
