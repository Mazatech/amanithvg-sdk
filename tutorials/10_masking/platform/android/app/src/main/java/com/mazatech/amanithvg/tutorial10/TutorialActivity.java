...
import static com.mazatech.amanithvg.tutorial10.TutorialView.*;
...
public class TutorialActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(@NonNull Menu menu) {
        ...
        // build the menu
        menu.add(0, TUTORIAL_CHANGE_MASK_OPERATION_CMD, 0, "Change mask operation");
        menu.add(0, TUTORIAL_CHANGE_FIRST_MASK_CMD, 0, "Change first mask primitive");
        menu.add(0, TUTORIAL_CHANGE_SECOND_MASK_CMD, 0, "Change second mask primitive");
