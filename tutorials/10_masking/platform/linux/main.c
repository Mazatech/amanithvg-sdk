...
static void helpDialog(void) {
    ...
    strcat(infoMessage, "Mouse: Move alpha masks.\n");
    strcat(infoMessage, "M: Change mask operation.\n");
    strcat(infoMessage, "F: Change first mask primitive.\n");
    strcat(infoMessage, "G: Change second mask primitive.\n");
